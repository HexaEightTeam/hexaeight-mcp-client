#!/usr/bin/env python3
"""
Test only the agent_manager functionality (without importing the full package)
"""
...
try:
    # Test agent_manager directly without going through __init__.py
    from hexaeight_mcp_client.agent_manager import HexaEightAgentManager, AgentCreationResult
    from hexaeight_mcp_client.exceptions import DotnetScriptError, AgentCreationError
    
    print("🧪 Testing HexaEightAgentManager (focused test)...")
    ...
    try:
        ...
        print("\nExample usage:")
        print(">>> from hexaeight_mcp_client import HexaEightAgentManager")
